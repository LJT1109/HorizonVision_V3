<template>
    <div v-component-name="'VideoNode'" :class="$style.TextNode" ref="draggable" @mousedown="dragStart">
        <div :class="$style.TextNodeBody">
            ...
            <!-- <p :class="$style.Title">Video{{ props.nodeProps.index }}</p> -->
            <UploadFile v-model="filename" :type="'video'"/>
